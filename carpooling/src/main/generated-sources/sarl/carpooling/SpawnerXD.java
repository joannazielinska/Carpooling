...
public class SpawnerXD extends Agent {
  @SyntheticMember
  ...
  @SyntheticMember
  public SpawnerXD(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public SpawnerXD(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public SpawnerXD(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
